...
public class NewListsData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_lists_data);
        recyclerView = (RecyclerView) findViewById(R.id.rvdata);
        addDataOnline();
    }
    void addDataOnline(){
        AndroidNetworking.get("http://192.168.6.24/api/getCustomerAll.php")
                .setTag("test")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(NewListsData.this);
